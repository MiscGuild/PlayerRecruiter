...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.all_players = [] 
        self.selected_frame = None # Storing which frame the user it currently looking at
        self.selected_text_box_pos = 0 # Helper variable for tab check
        self.switch_text = '\t' # Helper variable for tab check
        self.fix_offset_character = '               ' # Fixing issue where some labels have an offset
        ...
        self.skywars_wins = customtkinter.CTkLabel(self.stat_settings_frame,
                                                   text=f"Skywars Wins:{self.fix_offset_character}")
        ...
        self.stat_settings_frame.text_inputs.append(self.skywars_wins_entry)
        ...
        self.stat_settings_frame.text_inputs.append(self.skywars_level_entry)

        self.bedwars_wins = customtkinter.CTkLabel(self.stat_settings_frame,
                                                   text=f"Bedwars Wins:{self.fix_offset_character}")
        ...
        self.stat_settings_frame.text_inputs.append(self.bedwars_wins_entry)

        self.bedwars_stars = customtkinter.CTkLabel(self.stat_settings_frame,
                                                   text=f"Bedwars Stars:{self.fix_offset_character}")
        self.bedwars_stars.grid(row=4, column=2, padx=10, pady=10)
        self.bedwars_stars_entry = customtkinter.CTkTextbox(self.stat_settings_frame, width=80, height=1)
        self.bedwars_stars_entry.grid(row=4, column=3, padx=10, pady=10, sticky="w")
        self.bedwars_stars_entry.insert(0.0, settings.BEDWARS_STARS) # create text input where you can put the bedwars wins requirement
        self.stat_settings_frame.text_inputs.append(self.bedwars_stars_entry)


        self.bedwars_index = customtkinter.CTkLabel(self.stat_settings_frame,
                                                    text="Bedwars Index:")
        self.bedwars_index.grid(row=5, column=0, padx=10, pady=10, sticky="w")
        self.bedwars_index_entry = customtkinter.CTkTextbox(self.stat_settings_frame, width=80, height=1)
        self.bedwars_index_entry.grid(row=5, column=1, padx=10, pady=10, sticky="w")
        ...
        self.stat_settings_frame.text_inputs.append(self.bedwars_index_entry)

        self.bedwars_fkdr = customtkinter.CTkLabel(self.stat_settings_frame,
                                                   text=f"Bedwars FKDR:{self.fix_offset_character}")
        self.bedwars_fkdr.grid(row=5, column=2, padx=10, pady=10)
        self.bedwars_fkdr_entry = customtkinter.CTkTextbox(self.stat_settings_frame, width=80, height=1)
        self.bedwars_fkdr_entry.grid(row=5, column=3, padx=10, pady=10, sticky="w")
        ...
        self.stat_settings_frame.text_inputs.append(self.murder_mystery_wins_entry)

        self.minumum_gexp = customtkinter.CTkLabel(self.stat_settings_frame,
                                                   text="Minimum GEXP:")
        self.minumum_gexp.grid(row=8, column=0, padx=10, pady=10, sticky="w")
        self.minumum_gexp_entry = customtkinter.CTkTextbox(self.stat_settings_frame, width=80, height=1)
        self.minumum_gexp_entry.grid(row=8, column=1, padx=10, pady=10, sticky="w")
        ...
        self.stat_settings_frame.text_inputs.append(self.minumum_gexp_entry)

        self.maximum_guild_level = customtkinter.CTkLabel(self.stat_settings_frame,
                                                          text="Max Guild Level:")
        self.maximum_guild_level.grid(row=8, column=2, padx=10, pady=10, sticky="w")
        self.maximum_guild_level_entry = customtkinter.CTkTextbox(self.stat_settings_frame, width=80, height=1)
        self.maximum_guild_level_entry.grid(row=8, column=3, padx=10, pady=10, sticky="w") # create text input where you can put the maximum guild level requirement
        self.maximum_guild_level_entry.insert(0.0, settings.MAXIMUM_GUILD_LEVEL)
        self.stat_settings_frame.text_inputs.append(self.maximum_guild_level_entry)

        self.minimum_network_level = customtkinter.CTkLabel(self.stat_settings_frame,
                                                          text="Network Level:")
        self.minimum_network_level.grid(row=9, column=0, padx=10, pady=10, sticky="w")
        self.minimum_network_level_entry = customtkinter.CTkTextbox(self.stat_settings_frame, width=80, height=1)
        self.minimum_network_level_entry.grid(row=9, column=1, padx=10, pady=10, sticky="w") # create text input where you can put the minimum network level requirement
        self.minimum_network_level_entry.insert(0.0, settings.NETWORK_LEVEL)
        self.stat_settings_frame.text_inputs.append(self.minimum_network_level_entry)
        ...
        self.save_button = customtkinter.CTkButton(self.stat_settings_frame, text="Save", command=self.save_settings,
                                                   ...
                                                   hover_color=("gray70", "gray30"))
        self.save_button.grid(row=10, column=3, padx=0, pady=0, sticky="w") # create button where you can save your settings
        ...
        self.back_from_stat_settings_button = customtkinter.CTkButton(self.stat_settings_frame, text="   Back  ", command=self.settings_button_event,
                                                   ...
                                                   hover_color=("gray70", "gray30"))
        self.back_from_stat_settings_button.grid(row=10, column=2, padx=10, pady=10, sticky="w") # create button to bring you back to select settings frame
    ...
    def save_settings(self):
        ...
        BEDWARS_STARS = int(self.bedwars_stars_entry.get(1.0, "end-1c"))
        ...
        settings.updateSettings(API_KEY, PATH, SKYWARS_WINS, SKYWARS_LEVEL, BEDWARS_STARS, BEDWARS_WINS, BEDWARS_INDEX, BEDWARS_FKDR,
