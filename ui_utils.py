...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.save_button = customtkinter.CTkButton(self.settings_frame, text="Save", command=self.save_settings, width=80, height=10, corner_radius=20)
    ...
    def save_settings(self):
        ...
        settings.updateSettings(API_KEY, PATH, SKYWARS_WINS, SKYWARS_LEVEL, BEDWARS_WINS, BEDWARS_INDEX, BEDWARS_FKDR,
                                DUELS_WINS, DUELS_WLR, ARCADE_WINS, MURDER_MYSTERY_WINS, MINIMUM_GEXP, MAXIMUM_GUILD_LEVEL)
